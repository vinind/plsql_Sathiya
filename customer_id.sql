create table customer_id(digit_no number(5) constraint digit_no_pk primary key,
digit_1 number(5),digit_2 number(5),digit_3 number(5),digit_4 number(5),digit_5 number(5),digit_6 number(5));

create or replace procedure luhn_algorithm(in_number number)is
v_sum number(5);
begin
insert into customer_id(digit_no,digit_1,digit_2,digit_3,digit_4,digit_5)
